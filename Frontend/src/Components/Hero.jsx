...
function Hero() {
    return (
        <div className='h-[90vh] bg-hero bg-cover bg-center bg-no-repeat -z-10    '>
            <div className='bg-[#ffffffa8] h-full px-4 sm:px-10 flex flex-col justify-center gap-4 sm:gap-10'>
                <h1 className='text-green-500 sm:text-center font-bold text-3xl md:text-5xl'>Welcome to Green Market</h1>
                <p className='text-xl'>
                    <span className='text-green-600 font-semibold text-2xl sm:text-3xl'>GreenMarket</span> is a web-based platform designed to connect farmers directly with consumers, eliminating middlemen and ensuring that farmers receive fair prices for their crops. Customers can buy fresh, locally-sourced produce directly from farmers.
                </p>
                <p>
                    <h1 className='text-3xl font-bold mb-3'>Major Features: </h1>
                    <ul className='px-5'>
